...
/*
 * 贪心算法
 * 1.贪婪算法（贪心算法）是指在对问题进行求解时，在每一步选择中都采取最好，或者最优（即最有利）的选择，从而希望能够导致结果是最好或者最优的
 * 2.贪婪算法所得到的结果不一定是最优的结果（有时候会是最优解），但是都是相对（近似）最优解的结果
 */
...
public class GreedyAlgorithm {
	...
	// 定义一个maxKey，保存一次遍历过程中，能够覆盖最大未覆盖的地区对应的电台
